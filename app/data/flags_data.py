...
FLAG_SETS = {
    ...
    "world_cup": {
        ...
        "data": [
            ...
            {"id": 2, "name": "South Africa", "synonyms": ["south africa"], "image": "south_africa.png"},
            {"id": 3, "name": "South Korea", "synonyms": ["south korea"], "image": "south_korea.png"},
            {"id": 4, "name": "Czechia", "synonyms": ["czech republic", "czechia"], "image": "czechia.png"},
            {"id": 5, "name": "Canada", "synonyms": ["canada"], "image": "canada.png"},
            {"id": 6, "name": "Bosnia and Herzegovina", "synonyms": ["bosnia and herzegovina"], "image": "bosnia_and_herzegovina.png"},
            {"id": 7, "name": "Qatar", "synonyms": ["qatar"], "image": "qatar.png"},
            {"id": 8, "name": "Switzerland", "synonyms": ["switzerland"], "image": "switzerland.png"},
            {"id": 9, "name": "Brazil", "synonyms": ["brazil"], "image": "brazil.png"},
            ...
            {"id": 42, "name": "Democratic Republic of the Congo", "synonyms": ["democratic republic of the congo", "drc", "congo"], "image": "democratic_republic_of_the_congo.png"},
    ...
    "brazil_states": {
        ...
        "data": [
            ...
            {"id": 3, "name": "Amapá", "synonyms": ["amapa", "amapá"], "image": "amapa.png"},
            {"id": 4, "name": "Amazonas", "synonyms": ["amazonas"], "image": "amazonas.png"},
            {"id": 5, "name": "Bahia", "synonyms": ["bahia"], "image": "bahia.png"},
            {"id": 6, "name": "Ceará", "synonyms": ["ceara", "ceará"], "image": "ceara.png"},
            {"id": 7, "name": "Distrito Federal", "synonyms": ["distrito federal"], "image": "distrito_federal.png"},
            {"id": 8, "name": "Espírito Santo", "synonyms": ["espirito santo", "espírito santo"], "image": "espirito_santo.png"},
            {"id": 9, "name": "Goiás", "synonyms": ["goias", "goiás"], "image": "goias.png"},
            {"id": 10, "name": "Maranhão", "synonyms": ["maranhao", "maranhão"], "image": "maranhao.png"},
            ...
            {"id": 14, "name": "Pará", "synonyms": ["para", "pará"], "image": "para.png"},
            {"id": 15, "name": "Paraíba", "synonyms": ["paraiba", "paraíba"], "image": "paraiba.png"},
            {"id": 16, "name": "Paraná", "synonyms": ["parana", "paraná"], "image": "parana.png"},
            {"id": 17, "name": "Pernambuco", "synonyms": ["pernambuco"], "image": "pernambuco.png"},
            {"id": 18, "name": "Piauí", "synonyms": ["piaui", "piauí"], "image": "piaui.png"},
            ...
            {"id": 22, "name": "Rondônia", "synonyms": ["rondonia", "rondônia"], "image": "rondonia.png"},
            ...
            {"id": 25, "name": "São Paulo", "synonyms": ["sao paulo", "são paulo"], "image": "sao_paulo.png"},
